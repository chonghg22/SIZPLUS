			...
			<div class="row">
				<div class="col-md-6 tn-left">
					<div class="row tn-slider">
						<div class="col-md-6">
							<div class="tn-img" onclick="fn_emart()">
								<img src="/lib/user/img/main/emart.jpg" style="height: 344px;"/>
								<div class="tn-title">
									<a href="https://store.emart.com/news/leafletfull.do?division=2">[이마트 할인정보]</a>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="tn-img" onclick="fn_homeplus();">
								<img src="/lib/user/img/main/homeplus.jpg" style="height: 344px;"/>
								<div class="tn-title">
									<a href="">[홈플러스 할인정보]</a>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="tn-img" onclick="fn_lotte();">
								<img src="/lib/user/img/main/lottemart.jpg" style="height: 344px;"/>
								<div class="tn-title">
									<a href="">[롯데마트 할인정보]</a>
								</div>
							</div>
							...
							<div class="tn-news" style="margin-bottom: 19.5px;">
								<div class="tn-title" style="width: 100%;">
						           ...
						           <c:otherwise>
						            ...
						            <span style="float: right;color: #555;">${fn:substring(life.input_date,0,16)}</span>
								</div>
							</div>
							</c:forEach>
						</div>
...
function fn_emart(){
	window.open('https://store.emart.com/news/leafletfull.do?division=2');
}

function fn_lotte(){
	window.open('https://www.lotteon.com/p/display/shop/seltDpShop/40732?callType=menu');
}

function fn_homeplus(){
	window.open('https://front.homeplus.co.kr/express/theme?themeId=939');
}
