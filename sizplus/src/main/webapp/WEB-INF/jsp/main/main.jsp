				...
				<div class="col-md-6">
					...
					<div class="tab-content">
						<div id="featured" class="container tab-pane active">
							<a href="products.html" style="padding-left: 420px;">더보기 <i class="fa fa-angle-right"></i></a><br>
							<div class="tn-news">
								<div class="tn-img">
									<img src="lib/user/img/news-350x223-1.jpg" />
								</div>
				...
				<div class="col-md-6">
					...
					<div class="tab-content">
						...
						<div id="m-read" class="container tab-pane fade">
							<a href="products.html" style="padding-left: 420px;">더보기 <i
								class="fa fa-angle-right"></i></a><br>
							<div class="tn-news" style="margin-bottom: 19.5px;">
								<div class="tn-title">
									<a href="">1.공지사항</a>
								</div>
