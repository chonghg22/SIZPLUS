...
<body id="page-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">금주 접속현황</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">로그인 타입별 현황</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i>카카오
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i>구글
                                        </span>
                                        <span class="mr-2">
    ...
    <!-- Page level plugins -->
    <script src="/lib/mngr/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/lib/mngr/js/demo/chart-area-demo.js"></script>
    <script src="/lib/mngr/js/demo/chart-pie-demo.js"></script>
